...
class SerarchFriendResponseModel {
  ...
  final List<SearchFriendUserModel> data;

  SerarchFriendResponseModel({
  ...
  factory SerarchFriendResponseModel.fromJson(Map<String, dynamic> json) {
    return SerarchFriendResponseModel(
      success: json['success'] ?? false,
      message: json['message'] ?? '',
      pagination: PaginationModel.fromJson(json['pagination'] ?? {}),
      data: (json['data'] as List<dynamic>? ?? [])
          .map((e) => SearchFriendUserModel.fromJson(e))
          .toList(),
    );
  }
...
class SearchFriendUserModel {
  ...
  // ✅ FIXED: Initialize Rx variables directly
  final Rx<FriendStatus> friendStatus;
  final RxString pendingRequestId;

  SearchFriendUserModel({
    required this.id,
    required this.name,
    required this.role,
    required this.email,
