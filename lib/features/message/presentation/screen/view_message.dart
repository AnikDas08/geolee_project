...
import 'package:giolee78/features/home/presentation/widgets/message_details_dialog.dart';
import 'package:giolee78/features/message/presentation/controller/view_message_controller.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() {
        ...
        debugPrint(" post.user.image 😍😍😍😍 ${post!.user.image}");
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            CircleAvatar(
                              radius: 20.r,
                              backgroundImage: post.user.image == ""
