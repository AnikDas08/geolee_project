...
import 'package:giolee78/utils/constants/success_dialog.dart';
        ...
        child: SafeArea(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                CustomAppBar(title: "Custom Offer", showBackButton: true),
                ...
                CommonButton(
                  ...
                  onTap: () {
                    SuccessDialog.show(
                      ...
                      title: "Success",
                      message:
                          "Your custom offer has been submitted successfully.",
                      onPressed: () {
