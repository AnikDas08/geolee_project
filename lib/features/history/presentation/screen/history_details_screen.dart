...
import 'package:giolee78/features/history/presentation/controller/history_controller.dart';
...
class HistoryDetailsScreen extends StatelessWidget {
            ...
            child: Column(
              children: [
                ...
                if (controller.isPendingRequest)
                  _buildActionButtons(controller, request.id),
                ...
                Row(
                  children: [
                    ...List.generate(
                      ...
                      (index) => Icon(
                        Icons.star,
                        color: request.averageRating >= index + 1
                            ? Colors.amber
                            : Colors.grey,
                        size: 16.sp,
                      ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          DetailRow(label: 'Time', value: request.time),
          DetailRow(label: 'Priority Level', value: request.priorityLevel),
          DetailRow(label: 'Location', value: request.customerLocation),
        ],
      ),
    );
  }
  ...
  static void confirmDialog(HistoryDetailsController controller) {
    showDialog(
      context: Get.context!,
