class SuggestedFriendResponseModel {
  final bool success;
  final String message;
  final PaginationModel pagination;
  final List<SuggestedFriendUserModel> data;

  SuggestedFriendResponseModel({
  ...
  factory SuggestedFriendResponseModel.fromJson(Map<String, dynamic> json) {
    return SuggestedFriendResponseModel(
      success: json['success'] ?? false,
      message: json['message'] ?? '',
      pagination: PaginationModel.fromJson(json['pagination'] ?? {}),
      data: (json['data'] as List<dynamic>? ?? [])
          .map((e) => SuggestedFriendUserModel.fromJson(e))
          .toList(),
    );
  }
...
class SuggestedFriendUserModel {
  ...
  factory SuggestedFriendUserModel.fromJson(Map<String, dynamic> json) {
    return SuggestedFriendUserModel(
      id: json['_id'] ?? '',
      name: json['name'] ?? '',
      role: json['role'] ?? '',
      email: json['email'] ?? '',
